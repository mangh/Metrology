...
* [CALINE3 Application Benchmark](https://github.com/mangh/Metrology/blob/main/CALINE3/Benchmark/Program.cs) - approx. 1.25-fold increase in execution time (or 1.24-fold drop in performance; 1.24 &#8776; 2.701 ms / 2.177 ms),
